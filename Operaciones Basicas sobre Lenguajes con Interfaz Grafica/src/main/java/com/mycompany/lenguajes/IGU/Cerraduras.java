...
public class Cerraduras extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
     try {
        String ruta = System.getProperty("user.dir") + "/Resultados_Cerradura.txt";
        java.io.FileWriter writer = new java.io.FileWriter(ruta);
        writer.write(jTextArea1.getText());
        writer.close();

        javax.swing.JOptionPane.showMessageDialog(null, "Archivo guardado en:\n" + ruta);
